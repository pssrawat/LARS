...
#pragma GCC ivdep
					for (i = 1; i < N-1; i++) {
						...
						out[k][j+1][i] = a*alpha[k][j+1][i]*x[k][j+1][i] - b*h2inv*(
								0.0833*( 
									beta_i[k][j+1][i]*( 15.0*(x[k][j+1][i-1]-x[k][j+1][i])- (x[k][j+1][i-2]-x[k][j+1][i+1]) ) 
									+ beta_i[k][j+1][i+1]*( 15.0*(x[k][j+1][i+1]-x[k][j+1][i])- (x[k][j+1][i+2]-x[k][j+1][i-1]) ) 
									+ beta_j[k][j+1][i]*( 15.0*(x[k][j+1-1][i]-x[k][j+1][i])- (x[k][j+1-2][i]-x[k][j+1+1][i]) ) 
									+ beta_j[k][j+1+1][i]*( 15.0*(x[k][j+1+1][i]-x[k][j+1][i])- (x[k][j+1+2][i]-x[k][j+1-1][i]) ) 
									+ beta_k[k][j+1][i]*( 15.0*(x[k-1][j+1][i]-x[k][j+1][i])- (x[k-2][j+1][i]-x[k+1][j+1][i]) ) 
									+ beta_k[k+1][j+1][i]*( 15.0*(x[k+1][j+1][i]-x[k][j+1][i])- (x[k+2][j+1][i]-x[k-1][j+1][i]) ) 
								       )  
								+ 0.25*0.0833*(
									(beta_i[k][j+1+1][i]-beta_i[k][j+1-1][i]) * (x[k][j+1+1][i-1]-x[k][j+1+1][i]-x[k][j+1-1][i-1]+x[k][j+1-1][i])  
									+ (beta_i[k+1][j+1][i]-beta_i[k-1][j+1][i]) * (x[k+1][j+1][i-1]-x[k+1][j+1][i]-x[k-1][j+1][i-1]+x[k-1][j+1][i])  
									+ (beta_j[k][j+1][i+1]-beta_j[k][j+1][i-1]) * (x[k][j+1-1][i+1]-x[k][j+1][i+1]-x[k][j+1-1][i-1]+x[k][j+1][i-1])  
									+ (beta_j[k+1][j+1][i]-beta_j[k-1][j+1][i]) * (x[k+1][j+1-1][i]-x[k+1][j+1][i]-x[k-1][j+1-1][i]+x[k-1][j+1][i])  
									+ (beta_k[k][j+1][i+1]-beta_k[k][j+1][i-1]) * (x[k-1][j+1][i+1]-x[k][j+1][i+1]-x[k-1][j+1][i-1]+x[k][j+1][i-1])  
									+ (beta_k[k][j+1+1][i]-beta_k[k][j+1-1][i]) * (x[k-1][j+1+1][i]-x[k][j+1+1][i]-x[k-1][j+1-1][i]+x[k][j+1-1][i])  
									+ (beta_i[k][j+1+1][i+1]-beta_i[k][j+1-1][i+1]) * (x[k][j+1+1][i+1]-x[k][j+1+1][i]-x[k][j+1-1][i+1]+x[k][j+1-1][i])  
									+ (beta_i[k+1][j+1][i+1]-beta_i[k-1][j+1][i+1]) * (x[k+1][j+1][i+1]-x[k+1][j+1][i]-x[k-1][j+1][i+1]+x[k-1][j+1][i])  
									+ (beta_j[k][j+1+1][i+1]-beta_j[k][j+1+1][i-1]) * (x[k][j+1+1][i+1]-x[k][j+1][i+1]-x[k][j+1+1][i-1]+x[k][j+1][i-1])  
									+ (beta_j[k+1][j+1+1][i]-beta_j[k-1][j+1+1][i]) * (x[k+1][j+1+1][i]-x[k+1][j+1][i]-x[k-1][j+1+1][i]+x[k-1][j+1][i])  
									+ (beta_k[k+1][j+1][i+1]-beta_k[k+1][j+1][i-1]) * (x[k+1][j+1][i+1]-x[k][j+1][i+1]-x[k+1][j+1][i-1]+x[k][j+1][i-1])  
									+ (beta_k[k+1][j+1+1][i]-beta_k[k+1][j+1-1][i]) * (x[k+1][j+1+1][i]-x[k][j+1+1][i]-x[k+1][j+1-1][i]+x[k][j+1-1][i])));
						...
						out[k+1][j+1][i] = a*alpha[k+1][j+1][i]*x[k+1][j+1][i] - b*h2inv*(
								0.0833*( 
									beta_i[k+1][j+1][i]*( 15.0*(x[k+1][j+1][i-1]-x[k+1][j+1][i])- (x[k+1][j+1][i-2]-x[k+1][j+1][i+1]) ) 
									+ beta_i[k+1][j+1][i+1]*( 15.0*(x[k+1][j+1][i+1]-x[k+1][j+1][i])- (x[k+1][j+1][i+2]-x[k+1][j+1][i-1]) ) 
									+ beta_j[k+1][j+1][i]*( 15.0*(x[k+1][j+1-1][i]-x[k+1][j+1][i])- (x[k+1][j+1-2][i]-x[k+1][j+1+1][i]) ) 
									+ beta_j[k+1][j+1+1][i]*( 15.0*(x[k+1][j+1+1][i]-x[k+1][j+1][i])- (x[k+1][j+1+2][i]-x[k+1][j+1-1][i]) ) 
									+ beta_k[k+1][j+1][i]*( 15.0*(x[k+1-1][j+1][i]-x[k+1][j+1][i])- (x[k+1-2][j+1][i]-x[k+1+1][j+1][i]) ) 
									+ beta_k[k+1+1][j+1][i]*( 15.0*(x[k+1+1][j+1][i]-x[k+1][j+1][i])- (x[k+1+2][j+1][i]-x[k+1-1][j+1][i]) ) 
								       )  
								+ 0.25*0.0833*(
									(beta_i[k+1][j+1+1][i]-beta_i[k+1][j+1-1][i]) * (x[k+1][j+1+1][i-1]-x[k+1][j+1+1][i]-x[k+1][j+1-1][i-1]+x[k+1][j+1-1][i])  
									+ (beta_i[k+1+1][j+1][i]-beta_i[k+1-1][j+1][i]) * (x[k+1+1][j+1][i-1]-x[k+1+1][j+1][i]-x[k+1-1][j+1][i-1]+x[k+1-1][j+1][i])  
									+ (beta_j[k+1][j+1][i+1]-beta_j[k+1][j+1][i-1]) * (x[k+1][j+1-1][i+1]-x[k+1][j+1][i+1]-x[k+1][j+1-1][i-1]+x[k+1][j+1][i-1])  
									+ (beta_j[k+1+1][j+1][i]-beta_j[k+1-1][j+1][i]) * (x[k+1+1][j+1-1][i]-x[k+1+1][j+1][i]-x[k+1-1][j+1-1][i]+x[k+1-1][j+1][i])  
									+ (beta_k[k+1][j+1][i+1]-beta_k[k+1][j+1][i-1]) * (x[k+1-1][j+1][i+1]-x[k+1][j+1][i+1]-x[k+1-1][j+1][i-1]+x[k+1][j+1][i-1])  
									+ (beta_k[k+1][j+1+1][i]-beta_k[k+1][j+1-1][i]) * (x[k+1-1][j+1+1][i]-x[k+1][j+1+1][i]-x[k+1-1][j+1-1][i]+x[k+1][j+1-1][i])  
									+ (beta_i[k+1][j+1+1][i+1]-beta_i[k+1][j+1-1][i+1]) * (x[k+1][j+1+1][i+1]-x[k+1][j+1+1][i]-x[k+1][j+1-1][i+1]+x[k+1][j+1-1][i])  
									+ (beta_i[k+1+1][j+1][i+1]-beta_i[k+1-1][j+1][i+1]) * (x[k+1+1][j+1][i+1]-x[k+1+1][j+1][i]-x[k+1-1][j+1][i+1]+x[k+1-1][j+1][i])  
									+ (beta_j[k+1][j+1+1][i+1]-beta_j[k+1][j+1+1][i-1]) * (x[k+1][j+1+1][i+1]-x[k+1][j+1][i+1]-x[k+1][j+1+1][i-1]+x[k+1][j+1][i-1])  
									+ (beta_j[k+1+1][j+1+1][i]-beta_j[k+1-1][j+1+1][i]) * (x[k+1+1][j+1+1][i]-x[k+1+1][j+1][i]-x[k+1-1][j+1+1][i]+x[k+1-1][j+1][i])  
									+ (beta_k[k+1+1][j+1][i+1]-beta_k[k+1+1][j+1][i-1]) * (x[k+1+1][j+1][i+1]-x[k+1][j+1][i+1]-x[k+1+1][j+1][i-1]+x[k+1][j+1][i-1])  
									+ (beta_k[k+1+1][j+1+1][i]-beta_k[k+1+1][j+1-1][i]) * (x[k+1+1][j+1+1][i]-x[k+1][j+1+1][i]-x[k+1+1][j+1-1][i]+x[k+1][j+1-1][i])));
					}
				}
			}
		}
