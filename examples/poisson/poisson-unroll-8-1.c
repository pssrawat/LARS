...
#pragma GCC ivdep
					for (i = 1; i < N-1; i++) {
						...
						out[k+4][j][i] = 2.666*in[k+4][j][i] -
							(0.166*in[k+4-1][j][i] + 0.166*in[k+4+1][j][i] + 0.166*in[k+4][j-1][i] + 0.166*in[k+4][j+1][i] + 0.166*in[k+4][j][i+1] + 0.166*in[k+4][j][i-1])-
							(0.0833*in[k+4-1][j-1][i] + 0.0833*in[k+4+1][j-1][i] + 0.0833*in[k+4-1][j+1][i] + 0.0833*in[k+4+1][j+1][i] +
							 0.0833*in[k+4-1][j][i-1] + 0.0833*in[k+4+1][j][i-1] + 0.0833*in[k+4][j-1][i-1] + 0.0833*in[k+4][j+1][i-1] +
							 0.0833*in[k+4-1][j][i+1] + 0.0833*in[k+4+1][j][i+1] + 0.0833*in[k+4][j-1][i+1] + 0.0833*in[k+4][j+1][i+1]);

						out[k+5][j][i] = 2.666*in[k+5][j][i] -
							(0.166*in[k+5-1][j][i] + 0.166*in[k+5+1][j][i] + 0.166*in[k+5][j-1][i] + 0.166*in[k+5][j+1][i] + 0.166*in[k+5][j][i+1] + 0.166*in[k+5][j][i-1])-
							(0.0833*in[k+5-1][j-1][i] + 0.0833*in[k+5+1][j-1][i] + 0.0833*in[k+5-1][j+1][i] + 0.0833*in[k+5+1][j+1][i] +
							 0.0833*in[k+5-1][j][i-1] + 0.0833*in[k+5+1][j][i-1] + 0.0833*in[k+5][j-1][i-1] + 0.0833*in[k+5][j+1][i-1] +
							 0.0833*in[k+5-1][j][i+1] + 0.0833*in[k+5+1][j][i+1] + 0.0833*in[k+5][j-1][i+1] + 0.0833*in[k+5][j+1][i+1]);

						out[k+6][j][i] = 2.666*in[k+6][j][i] -
							(0.166*in[k+6-1][j][i] + 0.166*in[k+6+1][j][i] + 0.166*in[k+6][j-1][i] + 0.166*in[k+6][j+1][i] + 0.166*in[k+6][j][i+1] + 0.166*in[k+6][j][i-1])-
							(0.0833*in[k+6-1][j-1][i] + 0.0833*in[k+6+1][j-1][i] + 0.0833*in[k+6-1][j+1][i] + 0.0833*in[k+6+1][j+1][i] +
							 0.0833*in[k+6-1][j][i-1] + 0.0833*in[k+6+1][j][i-1] + 0.0833*in[k+6][j-1][i-1] + 0.0833*in[k+6][j+1][i-1] +
							 0.0833*in[k+6-1][j][i+1] + 0.0833*in[k+6+1][j][i+1] + 0.0833*in[k+6][j-1][i+1] + 0.0833*in[k+6][j+1][i+1]);

						out[k+7][j][i] = 2.666*in[k+7][j][i] -
							(0.166*in[k+7-1][j][i] + 0.166*in[k+7+1][j][i] + 0.166*in[k+7][j-1][i] + 0.166*in[k+7][j+1][i] + 0.166*in[k+7][j][i+1] + 0.166*in[k+7][j][i-1])-
							(0.0833*in[k+7-1][j-1][i] + 0.0833*in[k+7+1][j-1][i] + 0.0833*in[k+7-1][j+1][i] + 0.0833*in[k+7+1][j+1][i] +
							 0.0833*in[k+7-1][j][i-1] + 0.0833*in[k+7+1][j][i-1] + 0.0833*in[k+7][j-1][i-1] + 0.0833*in[k+7][j+1][i-1] +
							 0.0833*in[k+7-1][j][i+1] + 0.0833*in[k+7+1][j][i+1] + 0.0833*in[k+7][j-1][i+1] + 0.0833*in[k+7][j+1][i+1]);
					}
				}
			}
