...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 1; i < N-1; i++) {
						...
						out[k+4][j][i] = c[0] * in[k+4][j][i] + c[1] * (in[k+4-1][j][i] + in[k+4+1][j][i] + in[k+4][j-1][i] + in[k+4][j+1][i] + in[k+4][j][i-1] + in[k+4][j][i+1]) + c[2] * (in[k+4-1][j-1][i-1] + in[k+4-1][j-1][i+1] + in[k+4-1][j+1][i-1] + in[k+4-1][j+1][i+1] + in[k+4+1][j-1][i-1] + in[k+4+1][j-1][i+1] + in[k+4+1][j+1][i-1] + in[k+4+1][j+1][i+1]) + c[3] * (in[k+4-1][j-1][i] + in[k+4-1][j][i-1] + in[k+4-1][j][i+1] + in[k+4-1][j+1][i] + in[k+4][j-1][i-1] + in[k+4][j-1][i+1] + in[k+4][j+1][i-1] + in[k+4][j+1][i+1] + in[k+4+1][j-1][i] + in[k+4+1][j][i-1] + in[k+4+1][j][i+1] + in[k+4+1][j+1][i]);
						out[k+5][j][i] = c[0] * in[k+5][j][i] + c[1] * (in[k+5-1][j][i] + in[k+5+1][j][i] + in[k+5][j-1][i] + in[k+5][j+1][i] + in[k+5][j][i-1] + in[k+5][j][i+1]) + c[2] * (in[k+5-1][j-1][i-1] + in[k+5-1][j-1][i+1] + in[k+5-1][j+1][i-1] + in[k+5-1][j+1][i+1] + in[k+5+1][j-1][i-1] + in[k+5+1][j-1][i+1] + in[k+5+1][j+1][i-1] + in[k+5+1][j+1][i+1]) + c[3] * (in[k+5-1][j-1][i] + in[k+5-1][j][i-1] + in[k+5-1][j][i+1] + in[k+5-1][j+1][i] + in[k+5][j-1][i-1] + in[k+5][j-1][i+1] + in[k+5][j+1][i-1] + in[k+5][j+1][i+1] + in[k+5+1][j-1][i] + in[k+5+1][j][i-1] + in[k+5+1][j][i+1] + in[k+5+1][j+1][i]);
						out[k+6][j][i] = c[0] * in[k+6][j][i] + c[1] * (in[k+6-1][j][i] + in[k+6+1][j][i] + in[k+6][j-1][i] + in[k+6][j+1][i] + in[k+6][j][i-1] + in[k+6][j][i+1]) + c[2] * (in[k+6-1][j-1][i-1] + in[k+6-1][j-1][i+1] + in[k+6-1][j+1][i-1] + in[k+6-1][j+1][i+1] + in[k+6+1][j-1][i-1] + in[k+6+1][j-1][i+1] + in[k+6+1][j+1][i-1] + in[k+6+1][j+1][i+1]) + c[3] * (in[k+6-1][j-1][i] + in[k+6-1][j][i-1] + in[k+6-1][j][i+1] + in[k+6-1][j+1][i] + in[k+6][j-1][i-1] + in[k+6][j-1][i+1] + in[k+6][j+1][i-1] + in[k+6][j+1][i+1] + in[k+6+1][j-1][i] + in[k+6+1][j][i-1] + in[k+6+1][j][i+1] + in[k+6+1][j+1][i]);
						out[k+7][j][i] = c[0] * in[k+7][j][i] + c[1] * (in[k+7-1][j][i] + in[k+7+1][j][i] + in[k+7][j-1][i] + in[k+7][j+1][i] + in[k+7][j][i-1] + in[k+7][j][i+1]) + c[2] * (in[k+7-1][j-1][i-1] + in[k+7-1][j-1][i+1] + in[k+7-1][j+1][i-1] + in[k+7-1][j+1][i+1] + in[k+7+1][j-1][i-1] + in[k+7+1][j-1][i+1] + in[k+7+1][j+1][i-1] + in[k+7+1][j+1][i+1]) + c[3] * (in[k+7-1][j-1][i] + in[k+7-1][j][i-1] + in[k+7-1][j][i+1] + in[k+7-1][j+1][i] + in[k+7][j-1][i-1] + in[k+7][j-1][i+1] + in[k+7][j+1][i-1] + in[k+7][j+1][i+1] + in[k+7+1][j-1][i] + in[k+7+1][j][i-1] + in[k+7+1][j][i+1] + in[k+7+1][j+1][i]);
					}
				}
			}
		}
