...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 1; i < N-1; i++) {
						...
						out[k][j+1][i] = c[0] * in[k][j+1][i] + c[1] * (in[k-1][j+1][i] + in[k+1][j+1][i] + in[k][j+1-1][i] + in[k][j+1+1][i] + in[k][j+1][i-1] + in[k][j+1][i+1]) + c[2] * (in[k-1][j+1-1][i-1] + in[k-1][j+1-1][i+1] + in[k-1][j+1+1][i-1] + in[k-1][j+1+1][i+1] + in[k+1][j+1-1][i-1] + in[k+1][j+1-1][i+1] + in[k+1][j+1+1][i-1] + in[k+1][j+1+1][i+1]) + c[3] * (in[k-1][j+1-1][i] + in[k-1][j+1][i-1] + in[k-1][j+1][i+1] + in[k-1][j+1+1][i] + in[k][j+1-1][i-1] + in[k][j+1-1][i+1] + in[k][j+1+1][i-1] + in[k][j+1+1][i+1] + in[k+1][j+1-1][i] + in[k+1][j+1][i-1] + in[k+1][j+1][i+1] + in[k+1][j+1+1][i]);
						out[k+1][j+1][i] = c[0] * in[k+1][j+1][i] + c[1] * (in[k+1-1][j+1][i] + in[k+1+1][j+1][i] + in[k+1][j+1-1][i] + in[k+1][j+1+1][i] + in[k+1][j+1][i-1] + in[k+1][j+1][i+1]) + c[2] * (in[k+1-1][j+1-1][i-1] + in[k+1-1][j+1-1][i+1] + in[k+1-1][j+1+1][i-1] + in[k+1-1][j+1+1][i+1] + in[k+1+1][j+1-1][i-1] + in[k+1+1][j+1-1][i+1] + in[k+1+1][j+1+1][i-1] + in[k+1+1][j+1+1][i+1]) + c[3] * (in[k+1-1][j+1-1][i] + in[k+1-1][j+1][i-1] + in[k+1-1][j+1][i+1] + in[k+1-1][j+1+1][i] + in[k+1][j+1-1][i-1] + in[k+1][j+1-1][i+1] + in[k+1][j+1+1][i-1] + in[k+1][j+1+1][i+1] + in[k+1+1][j+1-1][i] + in[k+1+1][j+1][i-1] + in[k+1+1][j+1][i+1] + in[k+1+1][j+1+1][i]);
						out[k+2][j+1][i] = c[0] * in[k+2][j+1][i] + c[1] * (in[k+2-1][j+1][i] + in[k+2+1][j+1][i] + in[k+2][j+1-1][i] + in[k+2][j+1+1][i] + in[k+2][j+1][i-1] + in[k+2][j+1][i+1]) + c[2] * (in[k+2-1][j+1-1][i-1] + in[k+2-1][j+1-1][i+1] + in[k+2-1][j+1+1][i-1] + in[k+2-1][j+1+1][i+1] + in[k+2+1][j+1-1][i-1] + in[k+2+1][j+1-1][i+1] + in[k+2+1][j+1+1][i-1] + in[k+2+1][j+1+1][i+1]) + c[3] * (in[k+2-1][j+1-1][i] + in[k+2-1][j+1][i-1] + in[k+2-1][j+1][i+1] + in[k+2-1][j+1+1][i] + in[k+2][j+1-1][i-1] + in[k+2][j+1-1][i+1] + in[k+2][j+1+1][i-1] + in[k+2][j+1+1][i+1] + in[k+2+1][j+1-1][i] + in[k+2+1][j+1][i-1] + in[k+2+1][j+1][i+1] + in[k+2+1][j+1+1][i]);
						out[k+3][j+1][i] = c[0] * in[k+3][j+1][i] + c[1] * (in[k+3-1][j+1][i] + in[k+3+1][j+1][i] + in[k+3][j+1-1][i] + in[k+3][j+1+1][i] + in[k+3][j+1][i-1] + in[k+3][j+1][i+1]) + c[2] * (in[k+3-1][j+1-1][i-1] + in[k+3-1][j+1-1][i+1] + in[k+3-1][j+1+1][i-1] + in[k+3-1][j+1+1][i+1] + in[k+3+1][j+1-1][i-1] + in[k+3+1][j+1-1][i+1] + in[k+3+1][j+1+1][i-1] + in[k+3+1][j+1+1][i+1]) + c[3] * (in[k+3-1][j+1-1][i] + in[k+3-1][j+1][i-1] + in[k+3-1][j+1][i+1] + in[k+3-1][j+1+1][i] + in[k+3][j+1-1][i-1] + in[k+3][j+1-1][i+1] + in[k+3][j+1+1][i-1] + in[k+3][j+1+1][i+1] + in[k+3+1][j+1-1][i] + in[k+3+1][j+1][i-1] + in[k+3+1][j+1][i+1] + in[k+3+1][j+1+1][i]);
					}
				}
			}
		}
