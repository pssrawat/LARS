...
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --print-intrinsics false --split-size $ac --sort-function v6
sed -i '/#pragma begin '"$name"'/r '"slc-acc-$name"'.c' accumulate.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v0
sed -i '/#pragma begin '"$name"'/r '"slc-$name"'.c' reordered-a.c
sed -i '/#pragma begin '"$name"'/r '"$name"'.c' reordered-b.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v0-ilp
sed -i '/#pragma begin '"$name"'/r '"$name"'.c' reordered-c.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v1
sed -i '/#pragma begin '"$name"'/r '"$name"'.c' reordered-d.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v1-ilp
sed -i '/#pragma begin '"$name"'/r '"$name"'.c' reordered-e.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v2
sed -i '/#pragma begin '"$name"'/r '"$name"'.c' reordered-f.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v2-ilp
sed -i '/#pragma begin '"$name"'/r '"$name"'.c' reordered-g.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v3
sed -i '/#pragma begin '"$name"'/r '"$name"'.c' reordered-h.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v3-ilp
sed -i '/#pragma begin '"$name"'/r '"$name"'.c' reordered-i.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v4
sed -i '/#pragma begin '"$name"'/r '"$name"'.c' reordered-j.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v4-ilp
sed -i '/#pragma begin '"$name"'/r '"$name"'.c' reordered-k.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v5
sed -i '/#pragma begin '"$name"'/r '"$name"'.c' reordered-l.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v5-ilp
sed -i '/#pragma begin '"$name"'/r '"$name"'.c' reordered-m.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v6
sed -i '/#pragma begin '"$name"'/r '"$name"'.c' reordered-n.c
../../test $name.idsl --out-file $name.c --unroll $uf --distribute-rhs true --vect-size $vs --print-intrinsics $pi --split-size $ac --sort-function v6-ilp
