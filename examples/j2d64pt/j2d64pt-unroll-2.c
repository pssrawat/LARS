...
#pragma clang loop vectorize (enable) interleave(enable)
				for (i = 4; i < N-4; i++) {
					...
					out[j+1][i] =  c[0][0]*in[j+1-4][i-4] +  c[0][1]*in[j+1-4][i-3] + c[0][2]*in[j+1-4][i-2] + c[0][3]*in[j+1-4][i-1] + c[0][4]*in[j+1-4][i+1] + c[0][5]*in[j+1-4][i+2] + c[0][6]*in[j+1-4][i+3] + c[0][7]*in[j+1-4][i+4] +
						c[1][0]*in[j+1-3][i-4] +  c[1][1]*in[j+1-3][i-3] + c[1][2]*in[j+1-3][i-2] + c[1][3]*in[j+1-3][i-1] + c[1][4]*in[j+1-3][i+1] + c[1][5]*in[j+1-3][i+2] + c[1][6]*in[j+1-3][i+3] + c[1][7]*in[j+1-3][i+4] +
						c[2][0]*in[j+1-2][i-4] +  c[2][1]*in[j+1-2][i-3] + c[2][2]*in[j+1-2][i-2] + c[2][3]*in[j+1-2][i-1] + c[2][4]*in[j+1-2][i+1] + c[2][5]*in[j+1-2][i+2] + c[2][6]*in[j+1-2][i+3] + c[2][7]*in[j+1-2][i+4] +
						c[3][0]*in[j+1-1][i-4] +  c[3][1]*in[j+1-1][i-3] + c[3][2]*in[j+1-1][i-2] + c[3][3]*in[j+1-1][i-1] + c[3][4]*in[j+1-1][i+1] + c[3][5]*in[j+1-1][i+2] + c[3][6]*in[j+1-1][i+3] + c[3][7]*in[j+1-1][i+4] +
						c[4][0]*in[j+1+1][i-4] +  c[4][1]*in[j+1+1][i-3] + c[4][2]*in[j+1+1][i-2] + c[4][3]*in[j+1+1][i-1] + c[4][4]*in[j+1+1][i+1] + c[4][5]*in[j+1+1][i+2] + c[4][6]*in[j+1+1][i+3] + c[4][7]*in[j+1+1][i+4] +
						c[5][0]*in[j+1+2][i-4] +  c[5][1]*in[j+1+2][i-3] + c[5][2]*in[j+1+2][i-2] + c[5][3]*in[j+1+2][i-1] + c[5][4]*in[j+1+2][i+1] + c[5][5]*in[j+1+2][i+2] + c[5][6]*in[j+1+2][i+3] + c[5][7]*in[j+1+2][i+4] +
						c[6][0]*in[j+1+3][i-4] +  c[6][1]*in[j+1+3][i-3] + c[6][2]*in[j+1+3][i-2] + c[6][3]*in[j+1+3][i-1] + c[6][4]*in[j+1+3][i+1] + c[6][5]*in[j+1+3][i+2] + c[6][6]*in[j+1+3][i+3] + c[6][7]*in[j+1+3][i+4] +
						c[7][0]*in[j+1+4][i-4] +  c[7][1]*in[j+1+4][i-3] + c[7][2]*in[j+1+4][i-2] + c[7][3]*in[j+1+4][i-1] + c[7][4]*in[j+1+4][i+1] + c[7][5]*in[j+1+4][i+2] + c[7][6]*in[j+1+4][i+3] + c[7][7]*in[j+1+4][i+4];
				}
			}
		}
	}
