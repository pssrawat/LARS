...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 1; i < N-1; i++) {
						...
						vol_flux_x[k][j+1][i] = 0.125 * dt * xarea[k][j+1][i] * (xvel0[k][j+1][i] + xvel0[k][j+1+1][i] + xvel0[k+1][j+1][i] + xvel0[k+1][j+1+1][i] + xvel1[k][j+1][i] + xvel1[k][j+1+1][i] + xvel1[k+1][j+1][i] + xvel1[k+1][j+1+1][i]);
						...
						vol_flux_x[k+1][j+1][i] = 0.125 * dt * xarea[k+1][j+1][i] * (xvel0[k+1][j+1][i] + xvel0[k+1][j+1+1][i] + xvel0[k+1+1][j+1][i] + xvel0[k+1+1][j+1+1][i] + xvel1[k+1][j+1][i] + xvel1[k+1][j+1+1][i] + xvel1[k+1+1][j+1][i] + xvel1[k+1+1][j+1+1][i]);
					}
				}
			}
#pragma omp for private(j,i)
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 1; i < N-1; i++) {
						...
						vol_flux_y[k][j+1][i] = 0.125 * dt * yarea[k][j+1][i] * (yvel0[k][j+1][i] + yvel0[k][j+1][i+1] + yvel0[k+1][j+1][i] + yvel0[k+1][j+1][i+1] + yvel1[k][j+1][i] + yvel1[k][j+1][i+1] + yvel1[k+1][j+1][i] + yvel1[k+1][j+1][i+1]);
						...
						vol_flux_y[k+1][j+1][i] = 0.125 * dt * yarea[k+1][j+1][i] * (yvel0[k+1][j+1][i] + yvel0[k+1][j+1][i+1] + yvel0[k+1+1][j+1][i] + yvel0[k+1+1][j+1][i+1] + yvel1[k+1][j+1][i] + yvel1[k+1][j+1][i+1] + yvel1[k+1+1][j+1][i] + yvel1[k+1+1][j+1][i+1]);
					}
				}
			}
#pragma omp for private(j,i)
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 1; i < N-1; i++) {
						...
						vol_flux_z[k][j+1][i] = 0.125 * dt * zarea[k][j+1][i] * (zvel0[k][j+1][i] + zvel0[k][j+1][i+1] + zvel0[k][j+1][i+1] + zvel0[k][j+1+1][i+1] + zvel1[k][j+1][i] + zvel1[k][j+1][i+1] + zvel1[k][j+1+1][i] + zvel1[k][j+1+1][i+1]);
						...
						vol_flux_z[k+1][j+1][i] = 0.125 * dt * zarea[k+1][j+1][i] * (zvel0[k+1][j+1][i] + zvel0[k+1][j+1][i+1] + zvel0[k+1][j+1][i+1] + zvel0[k+1][j+1+1][i+1] + zvel1[k+1][j+1][i] + zvel1[k+1][j+1][i+1] + zvel1[k+1][j+1+1][i] + zvel1[k+1][j+1+1][i+1]);
					}
				}
			}
		}
