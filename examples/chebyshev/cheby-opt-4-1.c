...
#pragma begin stencil1 unroll k=1,j=1,i=1 print-intrinsics true acc-size 1
					out[k+3][j][i] = Ac[k+3][j][i] + c1 * (Ac[k+3][j][i] + Ap[k+3][j][i]) + c2 * Dinv[k+3][j][i] * (RHS[k+3][j][i] + (Ac[k+3][j][i] + h2inv * (0.03 * (Ac[k+3-1][j-1][i-1] + Ac[k+3-1][j-1][i+1] + Ac[k+3-1][j+1][i-1] + Ac[k+3-1][j+1][i+1] + Ac[k+3+1][j-1][i-1] + Ac[k+3+1][j-1][i+1] + Ac[k+3+1][j+1][i-1] + Ac[k+3+1][j+1][i+1]) + 0.1 * (Ac[k+3-1][j-1][i] + Ac[k+3-1][j][i-1] + Ac[k+3-1][j][i+1] + Ac[k+3-1][j+1][i] + Ac[k+3][j-1][i-1] + Ac[k+3][j-1][i+1] + Ac[k+3][j+1][i-1] + Ac[k+3][j+1][i+1] + Ac[k+3+1][j-1][i] + Ac[k+3+1][j][i-1] + Ac[k+3+1][j][i+1] + Ac[k+3+1][j+1][i]) + 0.46 * (Ac[k+3-1][j][i] + Ac[k+3][j-1][i] + Ac[k+3][j][i-1] + Ac[k+3][j][i+1] + Ac[k+3][j+1][i] + Ac[k+3+1][j][i]) + 4.26 * Ac[k+3][j][i])));

					out[k+2][j][i] = Ac[k+2][j][i] + c1 * (Ac[k+2][j][i] + Ap[k+2][j][i]) + c2 * Dinv[k+2][j][i] * (RHS[k+2][j][i] + (Ac[k+2][j][i] + h2inv * (0.03 * (Ac[k+2-1][j-1][i-1] + Ac[k+2-1][j-1][i+1] + Ac[k+2-1][j+1][i-1] + Ac[k+2-1][j+1][i+1] + Ac[k+2+1][j-1][i-1] + Ac[k+2+1][j-1][i+1] + Ac[k+2+1][j+1][i-1] + Ac[k+2+1][j+1][i+1]) + 0.1 * (Ac[k+2-1][j-1][i] + Ac[k+2-1][j][i-1] + Ac[k+2-1][j][i+1] + Ac[k+2-1][j+1][i] + Ac[k+2][j-1][i-1] + Ac[k+2][j-1][i+1] + Ac[k+2][j+1][i-1] + Ac[k+2][j+1][i+1] + Ac[k+2+1][j-1][i] + Ac[k+2+1][j][i-1] + Ac[k+2+1][j][i+1] + Ac[k+2+1][j+1][i]) + 0.46 * (Ac[k+2-1][j][i] + Ac[k+2][j-1][i] + Ac[k+2][j][i-1] + Ac[k+2][j][i+1] + Ac[k+2][j+1][i] + Ac[k+2+1][j][i]) + 4.26 * Ac[k+2][j][i])));
