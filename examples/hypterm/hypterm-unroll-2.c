...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						flux_0[k+1][j][i] += ((0.8*(cons_1[k+1][j][i+1]+cons_1[k+1][j][i-1])+0.2*(cons_1[k+1][j][i+2]+cons_1[k+1][j][i-2])+0.038*(cons_1[k+1][j][i+3]+cons_1[k+1][j][i-3])+0.0035*(cons_1[k+1][j][i+4]+cons_1[k+1][j][i-4]))*dxinv[0]);
						flux_0[k+1][j][i] += (0.8*(cons_2[k+1][j+1][i]+cons_2[k+1][j-1][i])+0.2*(cons_2[k+1][j+2][i]+cons_2[k+1][j-2][i])+0.038*(cons_2[k+1][j+3][i]+cons_2[k+1][j-3][i])+0.0035*(cons_2[k+1][j+4][i]+cons_2[k+1][j-4][i]))*dxinv[1];
						flux_0[k+1][j][i] += (0.8*(cons_3[k+1+1][j][i]+cons_3[k+1-1][j][i])+0.2*(cons_3[k+1+2][j][i]+cons_3[k+1-2][j][i])+0.038*(cons_3[k+1+3][j][i]+cons_3[k+1-3][j][i])+0.0035*(cons_3[k+1+4][j][i]+cons_3[k+1-4][j][i]))*dxinv[2];
					}
				} 
			}
		}
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						flux_1[k+1][j][i] += ((0.8*(cons_1[k+1][j][i+1]*q_1[k+1][j][i+1]+cons_1[k+1][j][i-1]*q_1[k+1][j][i-1]+(q_4[k+1][j][i+1]+q_4[k+1][j][i-1]))+0.2*(cons_1[k+1][j][i+2]*q_1[k+1][j][i+2]+cons_1[k+1][j][i-2]*q_1[k+1][j][i-2]+(q_4[k+1][j][i+2]+q_4[k+1][j][i-2]))+0.038*(cons_1[k+1][j][i+3]*q_1[k+1][j][i+3]+cons_1[k+1][j][i-3]*q_1[k+1][j][i-3]+(q_4[k+1][j][i+3]+q_4[k+1][j][i-3]))+0.0035*(cons_1[k+1][j][i+4]*q_1[k+1][j][i+4]+cons_1[k+1][j][i-4]*q_1[k+1][j][i-4]+(q_4[k+1][j][i+4]+q_4[k+1][j][i-4])))*dxinv[0]);
						flux_1[k+1][j][i] += (0.8*(cons_1[k+1][j+1][i]*q_2[k+1][j+1][i]+cons_1[k+1][j-1][i]*q_2[k+1][j-1][i])+0.2*(cons_1[k+1][j+2][i]*q_2[k+1][j+2][i]+cons_1[k+1][j-2][i]*q_2[k+1][j-2][i])+0.038*(cons_1[k+1][j+3][i]*q_2[k+1][j+3][i]+cons_1[k+1][j-3][i]*q_2[k+1][j-3][i])+0.0035*(cons_1[k+1][j+4][i]*q_2[k+1][j+4][i]+cons_1[k+1][j-4][i]*q_2[k+1][j-4][i]))*dxinv[1];
						flux_1[k+1][j][i] += (0.8*(cons_1[k+1+1][j][i]*q_3[k+1+1][j][i]+cons_1[k+1-1][j][i]*q_3[k+1-1][j][i])+0.2*(cons_1[k+1+2][j][i]*q_3[k+1+2][j][i]+cons_1[k+1-2][j][i]*q_3[k+1-2][j][i])+0.038*(cons_1[k+1+3][j][i]*q_3[k+1+3][j][i]+cons_1[k+1-3][j][i]*q_3[k+1-3][j][i])+0.0035*(cons_1[k+1+4][j][i]*q_3[k+1+4][j][i]+cons_1[k+1-4][j][i]*q_3[k+1-4][j][i]))*dxinv[2];
					}
				}
			}
		}
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						flux_2[k+1][j][i] += ((0.8*(cons_2[k+1][j][i+1]*q_1[k+1][j][i+1]+cons_2[k+1][j][i-1]*q_1[k+1][j][i-1])+0.2*(cons_2[k+1][j][i+2]*q_1[k+1][j][i+2]+cons_2[k+1][j][i-2]*q_1[k+1][j][i-2])+0.038*(cons_2[k+1][j][i+3]*q_1[k+1][j][i+3]+cons_2[k+1][j][i-3]*q_1[k+1][j][i-3])+0.0035*(cons_2[k+1][j][i+4]*q_1[k+1][j][i+4]+cons_2[k+1][j][i-4]*q_1[k+1][j][i-4]))*dxinv[0]);
						flux_2[k+1][j][i] += (0.8*(cons_2[k+1][j+1][i]*q_2[k+1][j+1][i]+cons_2[k+1][j-1][i]*q_2[k+1][j-1][i]+(q_4[k+1][j+1][i]+q_4[k+1][j-1][i]))+0.2*(cons_2[k+1][j+2][i]*q_2[k+1][j+2][i]+cons_2[k+1][j-2][i]*q_2[k+1][j-2][i]+(q_4[k+1][j+2][i]+q_4[k+1][j-2][i]))+0.038*(cons_2[k+1][j+3][i]*q_2[k+1][j+3][i]+cons_2[k+1][j-3][i]*q_2[k+1][j-3][i]+(q_4[k+1][j+3][i]+q_4[k+1][j-3][i]))+0.0035*(cons_2[k+1][j+4][i]*q_2[k+1][j+4][i]+cons_2[k+1][j-4][i]*q_2[k+1][j-4][i]+(q_4[k+1][j+4][i]+q_4[k+1][j-4][i])))*dxinv[1];
						flux_2[k+1][j][i] += (0.8*(cons_2[k+1+1][j][i]*q_3[k+1+1][j][i]+cons_2[k+1-1][j][i]*q_3[k+1-1][j][i])+0.2*(cons_2[k+1+2][j][i]*q_3[k+1+2][j][i]+cons_2[k+1-2][j][i]*q_3[k+1-2][j][i])+0.038*(cons_2[k+1+3][j][i]*q_3[k+1+3][j][i]+cons_2[k+1-3][j][i]*q_3[k+1-3][j][i])+0.0035*(cons_2[k+1+4][j][i]*q_3[k+1+4][j][i]+cons_2[k+1-4][j][i]*q_3[k+1-4][j][i]))*dxinv[2];
					}
				}
			}
		} 
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						flux_3[k+1][j][i] += ((0.8*(cons_3[k+1][j][i+1]*q_1[k+1][j][i+1]+cons_3[k+1][j][i-1]*q_1[k+1][j][i-1])+0.2*(cons_3[k+1][j][i+2]*q_1[k+1][j][i+2]+cons_3[k+1][j][i-2]*q_1[k+1][j][i-2])+0.038*(cons_3[k+1][j][i+3]*q_1[k+1][j][i+3]+cons_3[k+1][j][i-3]*q_1[k+1][j][i-3])+0.0035*(cons_3[k+1][j][i+4]*q_1[k+1][j][i+4]+cons_3[k+1][j][i-4]*q_1[k+1][j][i-4]))*dxinv[0]);
						flux_3[k+1][j][i] += (0.8*(cons_3[k+1][j+1][i]*q_2[k+1][j+1][i]+cons_3[k+1][j-1][i]*q_2[k+1][j-1][i])+0.2*(cons_3[k+1][j+2][i]*q_2[k+1][j+2][i]+cons_3[k+1][j-2][i]*q_2[k+1][j-2][i])+0.038*(cons_3[k+1][j+3][i]*q_2[k+1][j+3][i]+cons_3[k+1][j-3][i]*q_2[k+1][j-3][i])+0.0035*(cons_3[k+1][j+4][i]*q_2[k+1][j+4][i]+cons_3[k+1][j-4][i]*q_2[k+1][j-4][i]))*dxinv[1];
						flux_3[k+1][j][i] += (0.8*(cons_3[k+1+1][j][i]*q_3[k+1+1][j][i]+cons_3[k+1-1][j][i]*q_3[k+1-1][j][i]+(q_4[k+1+1][j][i]+q_4[k+1-1][j][i]))+0.2*(cons_3[k+1+2][j][i]*q_3[k+1+2][j][i]+cons_3[k+1-2][j][i]*q_3[k+1-2][j][i]+(q_4[k+1+2][j][i]+q_4[k+1-2][j][i]))+0.038*(cons_3[k+1+3][j][i]*q_3[k+1+3][j][i]+cons_3[k+1-3][j][i]*q_3[k+1-3][j][i]+(q_4[k+1+3][j][i]+q_4[k+1-3][j][i]))+0.0035*(cons_3[k+1+4][j][i]*q_3[k+1+4][j][i]+cons_3[k+1-4][j][i]*q_3[k+1-4][j][i]+(q_4[k+1+4][j][i]+q_4[k+1-4][j][i])))*dxinv[2];
					}
				}
			}
		}
