					...
					for (i = 1; i < N-1; i++) {
						...
						out[k+3][j][i] = c[0][0]*in[k+3-1][j-1][i-1] + c[0][1]*in[k+3-1][j-1][i] + c[0][2]*in[k+3-1][j-1][i+1] +
							...
							c[8][0]*in[k+3+1][j+1][i-1] + c[8][1]*in[k+3+1][j+1][i] + c[8][2]*in[k+3+1][j+1][i+1];
                                                out[k+4][j][i] = c[0][0]*in[k+4-1][j-1][i-1] + c[0][1]*in[k+4-1][j-1][i] + c[0][2]*in[k+4-1][j-1][i+1] +
                                                        c[1][0]*in[k+4-1][j][i-1] +   c[1][1]*in[k+4-1][j][i] +   c[1][2]*in[k+4-1][j][i+1] +
                                                        c[2][0]*in[k+4-1][j+1][i-1] + c[2][1]*in[k+4-1][j+1][i] + c[2][2]*in[k+4-1][j+1][i+1] +
                                                        c[3][0]*in[k+4][j-1][i-1] +   c[3][1]*in[k+4][j-1][i] +   c[3][2]*in[k+4][j-1][i+1] +
                                                        c[4][0]*in[k+4][j][i-1] +     c[4][1]*in[k+4][j][i] +     c[4][2]*in[k+4][j][i+1] +
                                                        c[5][0]*in[k+4][j+1][i-1] +   c[5][1]*in[k+4][j+1][i] +   c[5][2]*in[k+4][j+1][i+1] +
                                                        c[6][0]*in[k+4+1][j-1][i-1] + c[6][1]*in[k+4+1][j-1][i] + c[6][2]*in[k+4+1][j-1][i+1] +
                                                        c[7][0]*in[k+4+1][j][i-1] +   c[7][1]*in[k+4+1][j][i] +   c[7][2]*in[k+4+1][j][i+1] +
                                                        c[8][0]*in[k+4+1][j+1][i-1] + c[8][1]*in[k+4+1][j+1][i] + c[8][2]*in[k+4+1][j+1][i+1];
                                                out[k+5][j][i] = c[0][0]*in[k+5-1][j-1][i-1] + c[0][1]*in[k+5-1][j-1][i] + c[0][2]*in[k+5-1][j-1][i+1] +
                                                        c[1][0]*in[k+5-1][j][i-1] +   c[1][1]*in[k+5-1][j][i] +   c[1][2]*in[k+5-1][j][i+1] +
                                                        c[2][0]*in[k+5-1][j+1][i-1] + c[2][1]*in[k+5-1][j+1][i] + c[2][2]*in[k+5-1][j+1][i+1] +
                                                        c[3][0]*in[k+5][j-1][i-1] +   c[3][1]*in[k+5][j-1][i] +   c[3][2]*in[k+5][j-1][i+1] +
                                                        c[4][0]*in[k+5][j][i-1] +     c[4][1]*in[k+5][j][i] +     c[4][2]*in[k+5][j][i+1] +
                                                        c[5][0]*in[k+5][j+1][i-1] +   c[5][1]*in[k+5][j+1][i] +   c[5][2]*in[k+5][j+1][i+1] +
                                                        c[6][0]*in[k+5+1][j-1][i-1] + c[6][1]*in[k+5+1][j-1][i] + c[6][2]*in[k+5+1][j-1][i+1] +
                                                        c[7][0]*in[k+5+1][j][i-1] +   c[7][1]*in[k+5+1][j][i] +   c[7][2]*in[k+5+1][j][i+1] +
                                                        c[8][0]*in[k+5+1][j+1][i-1] + c[8][1]*in[k+5+1][j+1][i] + c[8][2]*in[k+5+1][j+1][i+1];
                                                out[k+6][j][i] = c[0][0]*in[k+6-1][j-1][i-1] + c[0][1]*in[k+6-1][j-1][i] + c[0][2]*in[k+6-1][j-1][i+1] +
                                                        c[1][0]*in[k+6-1][j][i-1] +   c[1][1]*in[k+6-1][j][i] +   c[1][2]*in[k+6-1][j][i+1] +
                                                        c[2][0]*in[k+6-1][j+1][i-1] + c[2][1]*in[k+6-1][j+1][i] + c[2][2]*in[k+6-1][j+1][i+1] +
                                                        c[3][0]*in[k+6][j-1][i-1] +   c[3][1]*in[k+6][j-1][i] +   c[3][2]*in[k+6][j-1][i+1] +
                                                        c[4][0]*in[k+6][j][i-1] +     c[4][1]*in[k+6][j][i] +     c[4][2]*in[k+6][j][i+1] +
                                                        c[5][0]*in[k+6][j+1][i-1] +   c[5][1]*in[k+6][j+1][i] +   c[5][2]*in[k+6][j+1][i+1] +
                                                        c[6][0]*in[k+6+1][j-1][i-1] + c[6][1]*in[k+6+1][j-1][i] + c[6][2]*in[k+6+1][j-1][i+1] +
                                                        c[7][0]*in[k+6+1][j][i-1] +   c[7][1]*in[k+6+1][j][i] +   c[7][2]*in[k+6+1][j][i+1] +
                                                        c[8][0]*in[k+6+1][j+1][i-1] + c[8][1]*in[k+6+1][j+1][i] + c[8][2]*in[k+6+1][j+1][i+1];
                                                out[k+7][j][i] = c[0][0]*in[k+7-1][j-1][i-1] + c[0][1]*in[k+7-1][j-1][i] + c[0][2]*in[k+7-1][j-1][i+1] +
                                                        c[1][0]*in[k+7-1][j][i-1] +   c[1][1]*in[k+7-1][j][i] +   c[1][2]*in[k+7-1][j][i+1] +
                                                        c[2][0]*in[k+7-1][j+1][i-1] + c[2][1]*in[k+7-1][j+1][i] + c[2][2]*in[k+7-1][j+1][i+1] +
                                                        c[3][0]*in[k+7][j-1][i-1] +   c[3][1]*in[k+7][j-1][i] +   c[3][2]*in[k+7][j-1][i+1] +
                                                        c[4][0]*in[k+7][j][i-1] +     c[4][1]*in[k+7][j][i] +     c[4][2]*in[k+7][j][i+1] +
                                                        c[5][0]*in[k+7][j+1][i-1] +   c[5][1]*in[k+7][j+1][i] +   c[5][2]*in[k+7][j+1][i+1] +
                                                        c[6][0]*in[k+7+1][j-1][i-1] + c[6][1]*in[k+7+1][j-1][i] + c[6][2]*in[k+7+1][j-1][i+1] +
                                                        c[7][0]*in[k+7+1][j][i-1] +   c[7][1]*in[k+7+1][j][i] +   c[7][2]*in[k+7+1][j][i+1] +
                                                        c[8][0]*in[k+7+1][j+1][i-1] + c[8][1]*in[k+7+1][j+1][i] + c[8][2]*in[k+7+1][j+1][i+1];
					}
				}
			}
		}
