...
extern void diffterm_opt (double*, double*, double*, double*, double*, double*, double*, double*, double*, double*, double*, int);
...
int main (void) {
	cacheflush ();
	int N = 308; 
	double (*difflux_ref)[308+37][308+37][308+37] = (double (*)[308+37][308+37][308+37]) getZero4DArray(5, 308+37, 308+37, 308+37);
	double (*difflux)[308+37][308+37][308+37] = (double (*)[308+37][308+37][308+37]) getZero4DArray(5, 308+37, 308+37, 308+37);
	double (*q)[308+37][308+37][308+37] = (double (*)[308+37][308+37][308+37]) getRandom4DArray(6, 308+37, 308+37, 308+37);
	double (*ux)[308+37][308+37] = (double (*)[308+37][308+37]) getRandom3DArray(308+37, 308+37, 308+37);
	double (*uy)[308+37][308+37] = (double (*)[308+37][308+37]) getRandom3DArray(308+37, 308+37, 308+37);
	double (*uz)[308+37][308+37] = (double (*)[308+37][308+37]) getRandom3DArray(308+37, 308+37, 308+37);
	double (*wx)[308+37][308+37] = (double (*)[308+37][308+37]) getRandom3DArray(308+37, 308+37, 308+37);
	double (*wy)[308+37][308+37] = (double (*)[308+37][308+37]) getRandom3DArray(308+37, 308+37, 308+37);
	double (*wz)[308+37][308+37] = (double (*)[308+37][308+37]) getRandom3DArray(308+37, 308+37, 308+37);
	double (*vx)[308+37][308+37] = (double (*)[308+37][308+37]) getZero3DArray(308+37, 308+37, 308+37);
	double (*vy)[308+37][308+37] = (double (*)[308+37][308+37]) getZero3DArray(308+37, 308+37, 308+37);
	double (*vz)[308+37][308+37] = (double (*)[308+37][308+37]) getZero3DArray(308+37, 308+37, 308+37);
	double dxinv0 = 0.01;
	double dxinv1 = 0.02;
	double dxinv2 = 0.03;
	double tauxx = 0.3131;
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						difflux_ref[1][k][j][i] =  0.3311 * (1.333 * uxx + uyy + uzz + 0.333 * (vyx + wzx));
					}
				}
			}
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						difflux_ref[2][k][j][i] =  0.3311 * (vxx+1.333 * vyy + vzz + 0.333 * (uxy + wzy));
					}
				}
			}
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						difflux_ref[3][k][j][i] =  0.3311 * (wxx + wyy+1.333 * wzz + 0.333 * (uxz + vyz));
					}
				}
			}
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						mechwork =  0.3311 * mechwork + difflux_ref[1][k][j][i] * q[1][k][j][i] + difflux_ref[2][k][j][i] * q[2][k][j][i] + difflux_ref[3][k][j][i] * q[3][k][j][i];
						difflux_ref[4][k][j][i] =  0.1 * 0.7112 * (txx + tyy + tzz) + mechwork;
					}
				}
			}
		}
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						mechwork = tauxx * ux[k][j][i] + tauyy * vy[k][j][i] + tauzz * wz[k][j][i] + (tauxy*tauxy) + (tauxz*tauxz) + (tauyz*tauyz);
						mechwork =  0.3311 * mechwork + difflux_ref[1][k][j][i] * q[1][k][j][i] + difflux_ref[2][k][j][i] * q[2][k][j][i] + difflux_ref[3][k][j][i] * q[3][k][j][i];
						difflux_ref[4][k][j][i] =  0.7112 * (txx + tyy + tzz) + mechwork;
					}
				}
			}
		}
	...
	diffterm_opt ((double*)difflux, (double*)q, (double*)ux, (double*)uy, (double*)uz, (double*)vx, (double*)vy, (double*)vz, (double*)wx, (double*)wy, (double*)wz, N);

	double error = checkError4D (N, N, N, 37, (double*)difflux, (double*)difflux_ref, 1, 5, 5, N-5, 5, N-5, 5, N-5);
	if (error > TOLERANCE)
		printf ("error %e\n", error);
}
