...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						ux[k+1][j][i] = (0.8 * (q[1][k+1][j][i+1] - q[1][k+1][j][i-1]) + -0.2 * (q[1][k+1][j][i+2] - q[1][k+1][j][i-2]) + 0.038 * (q[1][k+1][j][i+3] - q[1][k+1][j][i-3]) + -0.0035 * (q[1][k+1][j][i+4] - q[1][k+1][j][i-4])) * dxinv0;
						vx[k+1][j][i] = (0.8 * (q[2][k+1][j][i+1] - q[2][k+1][j][i-1]) + -0.2 * (q[2][k+1][j][i+2] - q[2][k+1][j][i-2]) + 0.038 * (q[2][k+1][j][i+3] - q[2][k+1][j][i-3]) + -0.0035 * (q[2][k+1][j][i+4] - q[2][k+1][j][i-4])) * dxinv0;
						wx[k+1][j][i] = (0.8 * (q[3][k+1][j][i+1] - q[3][k+1][j][i-1]) + -0.2 * (q[3][k+1][j][i+2] - q[3][k+1][j][i-2]) + 0.038 * (q[3][k+1][j][i+3] - q[3][k+1][j][i-3]) + -0.0035 * (q[3][k+1][j][i+4] - q[3][k+1][j][i-4])) * dxinv0;
					}
				}
			}
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						uy[k+1][j][i] = (0.8 * (q[1][k+1][j+1][i] - q[1][k+1][j-1][i]) + -0.2 * (q[1][k+1][j+2][i] - q[1][k+1][j-2][i]) + 0.038 * (q[1][k+1][j+3][i] - q[1][k+1][j-3][i]) + -0.0035 * (q[1][k+1][j+4][i] - q[1][k+1][j-4][i])) * dxinv1;
						vy[k+1][j][i] = (0.8 * (q[2][k+1][j+1][i] - q[2][k+1][j-1][i]) + -0.2 * (q[2][k+1][j+2][i] - q[2][k+1][j-2][i]) + 0.038 * (q[2][k+1][j+3][i] - q[2][k+1][j-3][i]) + -0.0035 * (q[2][k+1][j+4][i] - q[2][k+1][j-4][i])) * dxinv1;
						wy[k+1][j][i] = (0.8 * (q[3][k+1][j+1][i] - q[3][k+1][j-1][i]) + -0.2 * (q[3][k+1][j+2][i] - q[3][k+1][j-2][i]) + 0.038 * (q[3][k+1][j+3][i] - q[3][k+1][j-3][i]) + -0.0035 * (q[3][k+1][j+4][i] - q[3][k+1][j-4][i])) * dxinv1;
					}
				}
			}
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						uz[k+1][j][i] = (0.8 * (q[1][k+1+1][j][i] - q[1][k+1-1][j][i]) + -0.2 * (q[1][k+1+2][j][i] - q[1][k+1-2][j][i]) + 0.038 * (q[1][k+1+3][j][i] - q[1][k+1-3][j][i]) + -0.0035 * (q[1][k+1+4][j][i] - q[1][k+1-4][j][i])) * dxinv2;
						vz[k+1][j][i] = (0.8 * (q[2][k+1+1][j][i] - q[2][k+1-1][j][i]) + -0.2 * (q[2][k+1+2][j][i] - q[2][k+1-2][j][i]) + 0.038 * (q[2][k+1+3][j][i] - q[2][k+1-3][j][i]) + -0.0035 * (q[2][k+1+4][j][i] - q[2][k+1-4][j][i])) * dxinv2;
						wz[k+1][j][i] = (0.8 * (q[3][k+1+1][j][i] - q[3][k+1-1][j][i]) + -0.2 * (q[3][k+1+2][j][i] - q[3][k+1-2][j][i]) + 0.038 * (q[3][k+1+3][j][i] - q[3][k+1-3][j][i]) + -0.0035 * (q[3][k+1+4][j][i] - q[3][k+1-4][j][i])) * dxinv2;
					}
				}
			}
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						uxx = (-2.847 * q[1][k+1][j][i]+1.6 * (q[1][k+1][j][i+1] + q[1][k+1][j][i-1]) + -0.2 * (q[1][k+1][j][i+2] + q[1][k+1][j][i-2]) + 0.0253 * (q[1][k+1][j][i+3] + q[1][k+1][j][i-3]) + -0.0017 * (q[1][k+1][j][i+4] + q[1][k+1][j][i-4])) * (dxinv0*dxinv0);
						uyy = (-2.847 * q[1][k+1][j][i]+1.6 * (q[1][k+1][j+1][i] + q[1][k+1][j-1][i]) + -0.2 * (q[1][k+1][j+2][i] + q[1][k+1][j-2][i]) + 0.0253 * (q[1][k+1][j+3][i] + q[1][k+1][j-3][i]) + -0.0017 * (q[1][k+1][j+4][i] + q[1][k+1][j-4][i])) * (dxinv1*dxinv1);
						uzz = (-2.847 * q[1][k+1][j][i]+1.6 * (q[1][k+1+1][j][i] + q[1][k+1-1][j][i]) + -0.2 * (q[1][k+1+2][j][i] + q[1][k+1-2][j][i]) + 0.0253 * (q[1][k+1+3][j][i] + q[1][k+1-3][j][i]) + -0.0017 * (q[1][k+1+4][j][i] + q[1][k+1-4][j][i])) * (dxinv2*dxinv2);
						vyx = (0.8 * (vy[k+1][j][i+1] - vy[k+1][j][i-1]) + -0.2 * (vy[k+1][j][i+2] - vy[k+1][j][i-2]) + 0.038 * (vy[k+1][j][i+3] - vy[k+1][j][i-3]) + -0.0035 * (vy[k+1][j][i+4] - vy[k+1][j][i-4])) * dxinv0;
						wzx = (0.8 * (wz[k+1][j][i+1] - wz[k+1][j][i-1]) + -0.2 * (wz[k+1][j][i+2] - wz[k+1][j][i-2]) + 0.038 * (wz[k+1][j][i+3] - wz[k+1][j][i-3]) + -0.0035 * (wz[k+1][j][i+4] - wz[k+1][j][i-4])) * dxinv0;
						difflux[1][k+1][j][i] =  0.3311 * (1.333 * uxx + uyy + uzz + 0.333 * (vyx + wzx));
					}
				}
			}
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						vxx = (-2.847 * q[2][k+1][j][i]+1.6 * (q[2][k+1][j][i+1] + q[2][k+1][j][i-1]) + -0.2 * (q[2][k+1][j][i+2] + q[2][k+1][j][i-2]) + 0.0253 * (q[2][k+1][j][i+3] + q[2][k+1][j][i-3]) + -0.0017 * (q[2][k+1][j][i+4] + q[2][k+1][j][i-4])) * (dxinv0*dxinv0);
						vyy = (-2.847 * q[2][k+1][j][i]+1.6 * (q[2][k+1][j+1][i] + q[2][k+1][j-1][i]) + -0.2 * (q[2][k+1][j+2][i] + q[2][k+1][j-2][i]) + 0.0253 * (q[2][k+1][j+3][i] + q[2][k+1][j-3][i]) + -0.0017 * (q[2][k+1][j+4][i] + q[2][k+1][j-4][i])) * (dxinv1*dxinv1);
						vzz = (-2.847 * q[2][k+1][j][i]+1.6 * (q[2][k+1+1][j][i] + q[2][k+1-1][j][i]) + -0.2 * (q[2][k+1+2][j][i] + q[2][k+1-2][j][i]) + 0.0253 * (q[2][k+1+3][j][i] + q[2][k+1-3][j][i]) + -0.0017 * (q[2][k+1+4][j][i] + q[2][k+1-4][j][i])) * (dxinv2*dxinv2);
						uxy = (0.8 * (ux[k+1][j+1][i] - ux[k+1][j-1][i]) + -0.2 * (ux[k+1][j+2][i] - ux[k+1][j-2][i]) + 0.038 * (ux[k+1][j+3][i] - ux[k+1][j-3][i]) + -0.0035 * (ux[k+1][j+4][i] - ux[k+1][j-4][i])) * dxinv1;
						wzy = (0.8 * (wz[k+1][j+1][i] - wz[k+1][j-1][i]) + -0.2 * (wz[k+1][j+2][i] - wz[k+1][j-2][i]) + 0.038 * (wz[k+1][j+3][i] - wz[k+1][j-3][i]) + -0.0035 * (wz[k+1][j+4][i] - wz[k+1][j-4][i])) * dxinv1;
						difflux[2][k+1][j][i] =  0.3311 * (vxx+1.333 * vyy + vzz + 0.333 * (uxy + wzy));
					}
				}
			}
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						wxx = (-2.847 * q[3][k+1][j][i]+1.6 * (q[3][k+1][j][i+1] + q[3][k+1][j][i-1]) + -0.2 * (q[3][k+1][j][i+2] + q[3][k+1][j][i-2]) + 0.0253 * (q[3][k+1][j][i+3] + q[3][k+1][j][i-3]) + -0.0017 * (q[3][k+1][j][i+4] + q[3][k+1][j][i-4])) * (dxinv0*dxinv0);
						wyy = (-2.847 * q[3][k+1][j][i]+1.6 * (q[3][k+1][j+1][i] + q[3][k+1][j-1][i]) + -0.2 * (q[3][k+1][j+2][i] + q[3][k+1][j-2][i]) + 0.0253 * (q[3][k+1][j+3][i] + q[3][k+1][j-3][i]) + -0.0017 * (q[3][k+1][j+4][i] + q[3][k+1][j-4][i])) * (dxinv1*dxinv1);
						wzz = (-2.847 * q[3][k+1][j][i]+1.6 * (q[3][k+1+1][j][i] + q[3][k+1-1][j][i]) + -0.2 * (q[3][k+1+2][j][i] + q[3][k+1-2][j][i]) + 0.0253 * (q[3][k+1+3][j][i] + q[3][k+1-3][j][i]) + -0.0017 * (q[3][k+1+4][j][i] + q[3][k+1-4][j][i])) * (dxinv2*dxinv2);
						uxz = (0.8 * (ux[k+1+1][j][i] - ux[k+1-1][j][i]) + -0.2 * (ux[k+1+2][j][i] - ux[k+1-2][j][i]) + 0.038 * (ux[k+1+3][j][i] - ux[k+1-3][j][i]) + -0.0035 * (ux[k+1+4][j][i] - ux[k+1-4][j][i])) * dxinv2;
						vyz = (0.8 * (vy[k+1+1][j][i] - vy[k+1-1][j][i]) + -0.2 * (vy[k+1+2][j][i] - vy[k+1-2][j][i]) + 0.038 * (vy[k+1+3][j][i] - vy[k+1-3][j][i]) + -0.0035 * (vy[k+1+4][j][i] - vy[k+1-4][j][i])) * dxinv2;
						difflux[3][k+1][j][i] =  0.3311 * (wxx + wyy+1.333 * wzz + 0.333 * (uxz + vyz));
					}
				}
			}
...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 4; i < N-4; i++) {
						...
						txx = (-2.847 * q[5][k+1][j][i]+1.6 * (q[5][k+1][j][i+1] + q[5][k+1][j][i-1]) + -0.2 * (q[5][k+1][j][i+2] + q[5][k+1][j][i-2]) + 0.0253 * (q[5][k+1][j][i+3] + q[5][k+1][j][i-3]) + -0.0017 * (q[5][k+1][j][i+4] + q[5][k+1][j][i-4])) * (dxinv0*dxinv0);
						tyy = (-2.847 * q[5][k+1][j][i]+1.6 * (q[5][k+1][j+1][i] + q[5][k+1][j-1][i]) + -0.2 * (q[5][k+1][j+2][i] + q[5][k+1][j-2][i]) + 0.0253 * (q[5][k+1][j+3][i] + q[5][k+1][j-3][i]) + -0.0017 * (q[5][k+1][j+4][i] + q[5][k+1][j-4][i])) * (dxinv1*dxinv1);
						tzz = (-2.847 * q[5][k+1][j][i]+1.6 * (q[5][k+1+1][j][i] + q[5][k+1-1][j][i]) + -0.2 * (q[5][k+1+2][j][i] + q[5][k+1-2][j][i]) + 0.0253 * (q[5][k+1+3][j][i] + q[5][k+1-3][j][i]) + -0.0017 * (q[5][k+1+4][j][i] + q[5][k+1-4][j][i])) * (dxinv2*dxinv2);
						divu = 0.666 * (ux[k+1][j][i] + vy[k+1][j][i] + wz[k+1][j][i]);
						tauxx = 2e0 * ux[k+1][j][i] - divu;
						tauyy = 2e0 * vy[k+1][j][i] - divu;
						tauzz = 2e0 * wz[k+1][j][i] - divu;
						tauxy = uy[k+1][j][i] + vx[k+1][j][i];
						tauxz = uz[k+1][j][i] + wx[k+1][j][i];
						tauyz = vz[k+1][j][i] + wy[k+1][j][i];
						mechwork = tauxx * ux[k+1][j][i] + tauyy * vy[k+1][j][i] + tauzz * wz[k+1][j][i] + (tauxy*tauxy) + (tauxz*tauxz) + (tauyz*tauyz);
						mechwork =  0.3311 * mechwork + difflux[1][k+1][j][i] * q[1][k+1][j][i] + difflux[2][k+1][j][i] * q[2][k+1][j][i] + difflux[3][k+1][j][i] * q[3][k+1][j][i];
						difflux[4][k+1][j][i] =  0.7112 * (txx + tyy + tzz) + mechwork;
					}
				}
			}
		}
