...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 1; i < N-1; i++) {
						...
						cc=cc+2.0*viscosity_a[k+1][j][i]/density0[k+1][j][i];
						dtct=ds*cc;
						dtct=dtc_safe*1.0/sqrt(dtct);
						...
						cc=cc+2.0*viscosity_a[k+2][j][i]/density0[k+2][j][i];
						dtct=ds*cc;
						dtct=dtc_safe*1.0/sqrt(dtct);
						...
						ds=1.0/(celldx[i]*celldy[j]*celldz[k+2+1]);
						cc=soundspeed[k+2+1][j][i]*soundspeed[k+2+1][j][i];
						cc=cc+2.0*viscosity_a[k+2+1][j][i]/density0[k+2+1][j][i];
						dtct=ds*cc;
						dtct=dtc_safe*1.0/sqrt(dtct);
						du1=(xvel0[k+2+1][j][i]+xvel0[k+2+1][j+1][i]+xvel0[k+2+1+1][j][i]+xvel0[k+2+1+1][j+1][i])*xarea[k+2+1][j][i];
						du2=(xvel0[k+2+1][j][i+1]+xvel0[k+2+1][j+1][i+1]+xvel0[k+2+1+1][j][i+1]+xvel0[k+2+1+1][j+1][i+1])*xarea[k+2+1][j][i];
						dtut=dtu_safe*4.0*volume[k+2+1][j][i]/(du1*du2*0.00001*volume[k+2+1][j][i]);
						dv1=(yvel0[k+2+1][j][i]+yvel0[k+2+1][j][i+1]+yvel0[k+2+1+1][j][i]+yvel0[k+2+1+1][j][i+1])*yarea[k+2+1][j][i];
						dv2=(yvel0[k+2+1][j+1][i]+yvel0[k+2+1][j+1][i+1]+yvel0[k+2+1+1][j+1][i]+yvel0[k+2+1+1][j+1][i+1])*yarea[k+2+1][j][i];
						dtvt=dtv_safe*4.0*volume[k+2+1][j][i]/(dv1*dv2*0.00001*volume[k+2+1][j][i]);
						dw1=(zvel0[k+2+1][j][i]+zvel0[k+2+1][j+1][i]+zvel0[k+2+1][j][i+1]+zvel0[k+2+1][j+1][i+1])*zarea[k+2+1][j][i];
						dw2=(zvel0[k+2+1+1][j][i]+zvel0[k+2+1+1][j+1][i]+zvel0[k+2+1+1][j][i+1]+zvel0[k+2+1+1][j+1][i+1])*zarea[k+2+1][j][i];
						dtwt=dtw_safe*4.0*volume[k+2+1][j][i]/(dw1*dw2*0.00001*volume[k+2+1][j][i]);
						div=du2-du1+dv2-dv1+dw2-dw1;
						dtdivt=dtdiv_safe*4.0*volume[k+2+1][j][i]/(volume[k+2+1][j][i]*0.00001*div);
						dt_min[k+2+1][j][i]=dtct*dtut*dtvt*dtwt*dtdivt;
					}
				}
			}
		}
