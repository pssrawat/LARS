...
#pragma clang loop vectorize (enable) interleave(enable)
				for (i = 3; i < N-3; i++) {
					out[j][i] =
						...
						c[6][0]*in[j+3][i-3] + c[6][1]*in[j+3][i-2] + c[6][2]*in[j+3][i-1] + c[6][3]*in[j+3][i] + c[6][4]*in[j+3][i+1] + c[6][5]*in[j+3][i+2] + c[6][6]*in[j+3][i+3];
					out[j+1][i] =
						c[0][0]*in[j+1-3][i-3] + c[0][1]*in[j+1-3][i-2] + c[0][2]*in[j+1-3][i-1] + c[0][3]*in[j+1-3][i] + c[0][4]*in[j+1-3][i+1] + c[0][5]*in[j+1-3][i+2] + c[0][6]*in[j+1-3][i+3] +
						c[1][0]*in[j+1-2][i-3] + c[1][1]*in[j+1-2][i-2] + c[1][2]*in[j+1-2][i-1] + c[1][3]*in[j+1-2][i] + c[1][4]*in[j+1-2][i+1] + c[1][5]*in[j+1-2][i+2] + c[1][6]*in[j+1-2][i+3] +
						c[2][0]*in[j+1-1][i-3] + c[2][1]*in[j+1-1][i-2] + c[2][2]*in[j+1-1][i-1] + c[2][3]*in[j+1-1][i] + c[2][4]*in[j+1-1][i+1] + c[2][5]*in[j+1-1][i+2] + c[2][6]*in[j+1-1][i+3] +
						c[3][0]*in[j+1][i-3] +   c[3][1]*in[j+1][i-2] +   c[3][2]*in[j+1][i-1] +   c[3][3]*in[j+1][i] +   c[3][4]*in[j+1][i+1] +   c[3][5]*in[j+1][i+2] +   c[3][6]*in[j+1][i+3] +
						c[4][0]*in[j+1+1][i-3] + c[4][1]*in[j+1+1][i-4] + c[4][2]*in[j+1+1][i-1] + c[4][3]*in[j+1+1][i] + c[4][4]*in[j+1+1][i+1] + c[4][5]*in[j+1+1][i+4] + c[4][6]*in[j+1+1][i+3] +
						c[5][0]*in[j+1+2][i-3] + c[5][1]*in[j+1+2][i-2] + c[5][2]*in[j+1+2][i-5] + c[5][3]*in[j+1+2][i] + c[5][4]*in[j+1+2][i+5] + c[5][5]*in[j+1+2][i+2] + c[5][6]*in[j+1+2][i+3] +
						c[6][0]*in[j+1+3][i-3] + c[6][1]*in[j+1+3][i-2] + c[6][2]*in[j+1+3][i-1] + c[6][3]*in[j+1+3][i] + c[6][4]*in[j+1+3][i+1] + c[6][5]*in[j+1+3][i+2] + c[6][6]*in[j+1+3][i+3];
				}
			}
		}
	}
