...
#pragma clang loop vectorize (enable) interleave(enable)
					for (i = 1; i < N-1; i++) {
						...
						left_flux =  (xarea[k][j+1][i]*(xvel0[k][j+1][i]+xvel0[k][j+1+1][i]+xvel0[k+1][j+1][i]+xvel0[k+1][j+1+1][i] +xvel0[k][j+1][i]+xvel0[k][j+1+1][i]+xvel0[k+1][j+1][i]+xvel0[k+1][j+1+1][i])) *0.125*dt*0.5;
						right_flux= (xarea[k][j+1][i+1]*(xvel0[k][j+1][i+1]+xvel0[k][j+1+1][i+1]+xvel0[k+1][j+1][i+1]+xvel0[k+1][j+1+1][i+1] +xvel0[k][j+1][i+1]+xvel0[k][j+1+1][i+1]+xvel0[k+1][j+1][i+1]+xvel0[k+1][j+1+1][i+1])) *0.125*dt*0.5;
						bottom_flux=(yarea[k][j+1][i]*(yvel0[k][j+1][i]+yvel0[k][j+1][i+1]+yvel0[k+1][j+1][i]+yvel0[k+1][j+1][i+1]  +yvel0[k][j+1][i]+yvel0[k][j+1][i+1]+yvel0[k+1][j+1][i]+yvel0[k+1][j+1][i+1])) *0.125*dt*0.5;
						top_flux=   (yarea[k][j+1+1][i]*(yvel0[k][j+1+1][i]+yvel0[k][j+1+1][i+1]+yvel0[k+1][j+1+1][i]+yvel0[k+1][j+1+1][i+1] + yvel0[k][j+1+1][i]+yvel0[k][j+1+1][i+1]+yvel0[k+1][j+1+1][i]+yvel0[k+1][j+1+1][i+1])) *0.125*dt*0.5;
						back_flux=  (zarea[k][j+1][i]*(zvel1[k][j+1][i]+zvel0[k][j+1][i+1]+zvel0[k][j+1+1][i]+zvel0[k][j+1+1][i+1]  +zvel0[k][j+1][i]+zvel0[k][j+1][i+1]+zvel0[k][j+1+1][i]+zvel0[k][j+1+1][i+1])) *0.125*dt*0.5;
						front_flux= (zarea[k+1][j+1][i]*(zvel0[k+1][j+1][i]+zvel0[k+1][j+1][i+1]+zvel0[k+1][j+1+1][i]+zvel0[k+1][j+1+1][i+1]  +zvel0[k+1][j+1][i]+zvel0[k+1][j+1][i+1]+zvel0[k+1][j+1+1][i]+zvel0[k+1][j+1+1][i+1])) *0.125*dt*0.5;
						total_flux=right_flux-left_flux+top_flux-bottom_flux+front_flux-back_flux;
						vol_change_s=volume[k][j+1][i]/(volume[k][j+1][i]+total_flux);
						min_cell_volume=(volume[k][j+1][i]+right_flux-left_flux+top_flux-bottom_flux+front_flux-back_flux + volume[k][j+1][i]+right_flux-left_flux+top_flux-bottom_flux + volume[k][j+1][i]+right_flux-left_flux + volume[k][j+1][i]+top_flux-bottom_flux);
						recip_volume=1.0/volume[k][j+1][i];
						energy_change=(pressure[k][j+1][i]/density0[k][j+1][i]+viscosity[k][j+1][i]/density0[k][j+1][i])*total_flux*recip_volume;
						energy1[k][j+1][i]=energy0[k][j+1][i]-energy_change;
						density1[k][j+1][i]=density0[k][j+1][i]*vol_change_s;
					}
				}
			}
		}
