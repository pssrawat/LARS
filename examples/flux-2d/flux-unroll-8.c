...
#pragma clang loop vectorize (enable) interleave(enable)
				for (i = 1; i < N-1; i++) {
					...
					vol_flux_x[j+4][i]=0.25*dt*xarea[j+4][i] *(xvel0[j+4][i]+xvel0[j+4+1][i]+xvel1[j+4][i]+xvel1[j+4+1][i]);
					vol_flux_x[j+4+1][i]=0.25*dt*xarea[j+4+1][i] *(xvel0[j+4+1][i]+xvel0[j+4+1+1][i]+xvel1[j+4+1][i]+xvel1[j+4+1+1][i]);
					vol_flux_x[j+4+2][i]=0.25*dt*xarea[j+4+2][i] *(xvel0[j+4+2][i]+xvel0[j+4+2+1][i]+xvel1[j+4+2][i]+xvel1[j+4+2+1][i]);
					vol_flux_x[j+4+3][i]=0.25*dt*xarea[j+4+3][i] *(xvel0[j+4+3][i]+xvel0[j+4+3+1][i]+xvel1[j+4+3][i]+xvel1[j+4+3+1][i]);
				}
			}
#pragma omp for private(i)
			for (j = 1; j < N-1; j+=8) {
...
#pragma clang loop vectorize (enable) interleave(enable)
				for (i = 1; i < N-1; i++) {
					...
					vol_flux_y[j+4][i]=0.25*dt*yarea[j+4][i] *(yvel0[j+4][i]+yvel0[j+4][i+1]+yvel1[j+4][i]+yvel1[j+4][i+1]);
					vol_flux_y[j+4+1][i]=0.25*dt*yarea[j+4+1][i] *(yvel0[j+4+1][i]+yvel0[j+4+1][i+1]+yvel1[j+4+1][i]+yvel1[j+4+1][i+1]);
					vol_flux_y[j+4+2][i]=0.25*dt*yarea[j+4+2][i] *(yvel0[j+4+2][i]+yvel0[j+4+2][i+1]+yvel1[j+4+2][i]+yvel1[j+4+2][i+1]);
					vol_flux_y[j+4+3][i]=0.25*dt*yarea[j+4+3][i] *(yvel0[j+4+3][i]+yvel0[j+4+3][i+1]+yvel1[j+4+3][i]+yvel1[j+4+3][i+1]);
				}
			}
		}
	}
