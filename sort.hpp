...
inline bool sort_order_metric_b6_ilp (tuple<string,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,vector<int>> a, tuple<string,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,vector<int>> b) {
	if (get<16>(a) != get<16>(b)) return (get<16>(a) > get<16>(b));
	if (get<1>(a) != get<1>(b)) return (get<1>(a) > get<1>(b));
	if (get<4>(a) != get<4>(b)) return (get<4>(a) > get<4>(b));
	if (get<5>(a) != get<5>(b)) return (get<5>(a) > get<5>(b));
